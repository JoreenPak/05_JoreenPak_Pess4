...
if (isset($_POST["btnDispatch"])){
	...
	incident_location, incident_desc, incident_status_id) VALUES('".$_POST['callerName
...
<table class="ContentStyle">
	...
	<tr>
		<td>Location :</td>
		<td><?php echo $_POST['location'] ?> <input type="hidden" name="location" id="location"
			value="<?php echo $_POST['location'] ?>"></td>
	</tr>
	<tr>
		<td>Incident Type :</td>
		<td><?php echo $_POST['incidentType'] ?> <input type="hidden" name="incidentType" id="incidentType"
